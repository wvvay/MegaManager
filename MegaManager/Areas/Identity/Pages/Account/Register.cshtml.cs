...
namespace MegaManager.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(256, ErrorMessage ="Максиум 100 символов")]
            [Display(Name = "Имя")]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "Подтвердите вашу почту",
                        $"Пожалуйста подтвердите Вашу почту <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>нажав сюда</a>.");
